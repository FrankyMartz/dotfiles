...
call NERDTreeAddKeyMap({
    ...
    \ 'quickhelpText': 'search files, case s(e)nsitive',
    \ 'scope': 'DirNode',
    \ })
...
call NERDTreeAddKeyMap({
    ...
    \ 'quickhelpText': '(s)earch files, case insensitive',
    \ 'scope': 'DirNode',
    \ })

" FIXME: Utilize function argument

function! NERDTreeAck(params)
...
function! NERDTreeAckSensitive(params)
    " get the current dir from NERDTree
    let cd = g:NERDTreeDirNode.GetSelected().path.str()
